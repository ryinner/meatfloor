...
/* harmony import */ var _Containers_Booking_Functional_Api_reservation_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/Containers/Booking/Functional/Api/reservation.api.js */ "./src/Frontend/Containers/Booking/Functional/Api/reservation.api.js");
/* harmony import */ var _Containers_Profile_Functional_Api_profile_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/Containers/Profile/Functional/Api/profile.api.js */ "./src/Frontend/Containers/Profile/Functional/Api/profile.api.js");
...
/* harmony import */ var _Shared_Helpers_dateConverter_helper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/Shared/Helpers/dateConverter.helper.js */ "./src/Frontend/Shared/Helpers/dateConverter.helper.js");
/* harmony import */ var _Shared_Helpers_pickTime_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/Shared/Helpers/pickTime.helper.js */ "./src/Frontend/Shared/Helpers/pickTime.helper.js");
/* harmony import */ var _Shared_State_useUserStore_useUserStore__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/Shared/State/useUserStore/useUserStore */ "./src/Frontend/Shared/State/useUserStore/useUserStore.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup(__props, {
    ...
    expose();
    const userState = (0,_Shared_State_useUserStore_useUserStore__WEBPACK_IMPORTED_MODULE_5__.useUserStore)();
    const user = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)({});
    const getData = async () => await (0,_Containers_Profile_Functional_Api_profile_api_js__WEBPACK_IMPORTED_MODULE_1__.getProfileIndex)().then(response => {
      user.value = response.data.user;
    });
    const remove = async id => await (0,_Containers_Booking_Functional_Api_reservation_api_js__WEBPACK_IMPORTED_MODULE_0__.removeReservation)(id).then(() => {
      user.value.reservations.splice(user.value.reservations.findIndex(reservation => reservation.id === id), 1);
    });
    (0,vue__WEBPACK_IMPORTED_MODULE_6__.onMounted)(getData);
    const __returned__ = {
      userState,
      user,
      getData,
      ...
      get removeReservation() {
        return _Containers_Booking_Functional_Api_reservation_api_js__WEBPACK_IMPORTED_MODULE_0__.removeReservation;
      },
      get getProfileIndex() {
        return _Containers_Profile_Functional_Api_profile_api_js__WEBPACK_IMPORTED_MODULE_1__.getProfileIndex;
      },
      BaseButton: _Shared_Components_BaseButton_BaseButton_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
      get dateConverterHelper() {
        return _Shared_Helpers_dateConverter_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"];
      },
      get pickTimeHelper() {
        return _Shared_Helpers_pickTime_helper_js__WEBPACK_IMPORTED_MODULE_4__["default"];
      },
      get useUserStore() {
        return _Shared_State_useUserStore_useUserStore__WEBPACK_IMPORTED_MODULE_5__.useUserStore;
      },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", _hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.userState.isAuthenticated ? $setup.userState.user.name : 'Пожалуйста авторизуйтесь'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_3, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.user.reservations, reservation => {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("article", {
      class: "profile__reservation reservation",
      key: reservation.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_4, "Стол №" + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(reservation.table_id), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, "С " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.pickTimeHelper(reservation.time_from)) + " до " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.pickTimeHelper(reservation.time_to)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, "Ждем вас в количестве " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(reservation.count) + " чел.", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.dateConverterHelper(reservation.time_from)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["BaseButton"], {
      size: "sm",
      onClick: $event => $setup.remove(reservation.id)
    }, {
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Отменить")]),
      _: 2 /* DYNAMIC */
...
/* harmony export */   "removeReservation": function() { return /* binding */ removeReservation; }
/* harmony export */ });
...
function removeReservation(id) {
  return _Plugins_Axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(`${prefix}/Remove`, {
    id
  });
}
